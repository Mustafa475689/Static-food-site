...
const ExploreMenu = ({ category, setCategory }) => {
  return (
    ...
    <p className='explore-menu-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. voluptatibus hic necessitatibus nobis natus officia repudiandae eligendi eum.</p>
